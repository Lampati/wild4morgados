        ...
        private void tc_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (e.AddedItems != null && e.AddedItems.Count > 0 && e.AddedItems[0] != null)
            {
                if (e.AddedItems[0].GetType() == typeof(TabItemAgregar))
                {
                    ...
                    {
                        CambioTabEventFire(e.AddedItems[0], new TipoTabCambiadoEventArgs(Enums.eTipoTab.TabItemAgregar));
                ...
                {
                    CambioTabEventFire(e.AddedItems[0], new TipoTabCambiadoEventArgs(Enums.eTipoTab.TabItemDeclaracionConstante));
                }
                else if (e.AddedItems[0].GetType() == typeof(TabItemDeclaracionVariable))
                {
                    CambioTabEventFire(e.AddedItems[0], new TipoTabCambiadoEventArgs(Enums.eTipoTab.TabItemDeclaracionVariable));
                }
                else if (e.AddedItems[0].GetType() == typeof(TabItemFuncion))
                {
                    CambioTabEventFire(e.AddedItems[0], new TipoTabCambiadoEventArgs(Enums.eTipoTab.TabItemFuncion));
                }
                else if (e.AddedItems[0].GetType() == typeof(TabItemProcedimiento))
                {
                    CambioTabEventFire(e.AddedItems[0], new TipoTabCambiadoEventArgs(Enums.eTipoTab.TabItemProcedimiento));
                }
                else if (e.AddedItems[0].GetType() == typeof(TabItemPrincipal))
                {
                    CambioTabEventFire(e.AddedItems[0], new TipoTabCambiadoEventArgs(Enums.eTipoTab.TabItemPrincipal));
                }
            }
            else
            {
