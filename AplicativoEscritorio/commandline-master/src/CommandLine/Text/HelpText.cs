...
namespace CommandLine.Text
{
    ...
    public class HelpText
    {
        ...
        {
            return new OptionSpecification(string.Empty, "ayuda", false, string.Empty, -1, -1, Maybe.Nothing<object>(), typeof(bool),
        ...
        private HelpText AddOption(string requiredWord, int maxLength, OptionSpecification option, int widthOfHelpText)
        {
            ...
            {
                optionHelpText = "(Valor por defecto: {0}) ".FormatLocal(option.DefaultValue.FromJust()) + optionHelpText;
            }
