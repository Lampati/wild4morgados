...
namespace Utilidades
{
    ...
    public class FastRandom
    {
        ...
        /// <summary>
        /// This generates a coin flip with a probability of returning true, else returning false.
        /// Probability must be between 0.0 and 1.0, inclusive.
        /// </summary>
        /// <param name="probabilidad"></param>
        /// <returns></returns>
        public bool NextBool(double probabilidad)
        {
            if ((probabilidad < 0.0) || (probabilidad > 1.0))
                throw new IndexOutOfRangeException("La probabilidad debe estar entre [0.0 ; 1.0]");
